...
class KafkaConsumer:
    ...
    def __init__(
        ...
        logging.info(f"Initialized Kafka consumer for topic {topic} with group {group_id}")
    ...
    async def healthcheck(self) -> dict[str, Any]:
        ...
        try:
            ...
            if partitions is None:
                return {"status": False,
                        "detail": f"Topic {self.topic} does not exist"}
    ...
    async def consume_batch(
        self, 
        processor: Callable[[list[dict[str, Any]]], int | None]
    ) -> int:
        ...
        try:
            ...
            async for message in self.consumer:
                ...
                if (
                        ...
                        current_time - start_time >= self.batch_timeout
                ):
